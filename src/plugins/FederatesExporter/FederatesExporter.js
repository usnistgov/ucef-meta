...
The federateInfos object uses federate names as property names and
has the form
...
The interactData and objectData values have the form:

{publish: n, subscribe: m} where n and m are each either 1 or 0, meaning
yes and no.
