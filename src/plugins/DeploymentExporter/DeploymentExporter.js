	   ...
	   combinations)
 {
	   ...
	   var interactionTraverser = function (interaction)
	     {
	       ...
	       return ejs.render(TEMPLATES["fedfile_siminteraction.ejs"],
				 intModel);
	     }
	   ...
	   var objectTraverser = function (object)
	     {
            ...
            self.objectRoots[0].children.forEach(function (obj)
	      {
            ...
            artifact.addFile('fom/' + self.projectName + '.fed',
			     ejs.render(TEMPLATES['fedfile.fed.ejs'],
					self.fomModel), function (err)
			     {
			       if (err)
				 {
				   callback(err);
		   ...
		   if (self.coaPathNode.hasOwnProperty(nodes))
			   ...
			   tempNode.nodeType === "Action")
			 {
			   tempNode.interactionName =
			     self.interactions[tempNode.interactionName].
			       fullName;
			 }
		  ...
		  if (self.experimentsGuid.hasOwnProperty(objPath))
		    {
			  ...
			  var array = {SelectionName: "",
				       ...
				       coaNodes: []};
			  coa_selection_name = [];
			  self.coaGroupNodes[coagroup.guid].
			    forEach(function (coanode)
			    {
				...
				coa_selection_nodes[coanode.name] || [];
		          ...
		          var cmb, a;
			  cmb = combinations.
			    combination(coa_selection_name,
                ...
                self.blobClient.saveAllArtifacts(function (err, hashes)
		  {
			...
			callback(err, self.result);
			  ...
			  ' was generated with id:[' + hashes[idx] + ']';
                    ...
                    self.save('DeploymentExporter updated model.',
			      function (err)
		      {
                        if (err)
			  {
   ...
   DeploymentExporter.prototype.visit_COASequencesGroup =
     function (node, parent, context)
     {
       ...
       // the next line seems useless since the line after sets the same thing
